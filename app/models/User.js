...
User.prototype.postUser = function(body, callback) {
    const values = [body.profile_picture, body.first_name, body.last_name, body.username, body.email, body.password, body.is_admin]
